...
That is where **we finally take advantage of the _Danish Investment Funds_! [[Q&A#Why should we not invest in ETFs or accumulating Danish investment funds outside of an _Aktiesparekonto_?|They are taxed as _Aktieindkomst_, and if they pay dividends, they are only taxed when realized (_Realisationsprincippet_)]]. Great!**
...
STIIAM is a great alternative to DKIGI and SPVIGAKL since it's an accumulating Danish Investment Fund and if you are okay with taking a bit more risk which we have highlighted in the [[Q&A#About _Storebrand Indeks - Alle Markeder A (STIIAM)_|about _Storebrand Indeks - Alle Markeder A (STIIAM)_ section]]. You might lose a little when buying or selling due to the low trading volume, and there’s a chance the tax rules could change again in the future.
