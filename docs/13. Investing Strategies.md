...
_Aktiesparekonto_ is an accessible investing account taxed at only 17%. Hence, we recommend investing only with the _Aktiesparekonto_ in the beginning up to the maximum contribution limit of 166.200 DKK (in 2025). This is the best move you can make early on due to the low taxes this account and provides.
