...
_Aktiesparekonto_ is an accessible investing account taxed at only 17%. Hence, we recommend investing only with the _Aktiesparekonto_ in the beginning up to the maximum contribution limit of 135.900 DKK (160.000 DKK starting in 2025). This is the best move you can make early on due to the low taxes this account provides.
...
| ETF name                                               | Ticker | Tracking Index        | ÅOP (Eng: TER) | Fund size (in billion $) | Currency | Gain in 2020 | Gain in 2021 | Gain in 2022<br/>(Corona Year) | Gain in 2023 | Gain YTD | Gain 5Y |
|:------------------------------------------------------ |:------ |:--------------------- |:-------------- |:------------------------ |:-------- |:------------ |:------------ |:------------------------------ |:------------ |:-------- |:------- |
| iShares Core S&P 500 UCITS ETF (Acc)                   | SXR8   | S&P 500               | 0,07%          | 85,273                   | USD      | 14,16%       | 29,99%       | -8,48%                         | 19,09%       | 10,39%   | 99,33%  |
| iShares Core MSCI World UCITS ETF USD (Acc)            | EUNL   | MSCI World Index      | 0,20%          | 74,301                   | USD      | 12,14%       | 23,48%       | -8,13%                         | 17,15%       | 8,90%    | 78,45%  |
| iShares Core MSCI Emerging Markets IMI UCITS ETF (Acc) | IS3N   | MSCI Emerging Markets | 0,18%          | 20,003                   | USD      | 14,44%       | 0,15%        | -9,28%                         | 5,51%        | 2,83%    | 21,55%  |
| iShares MSCI ACWI UCITS ETF USD (Acc)                  | IUSQ   | MSCI ACWI             | 0,20%          | 13,442                   | USD      | 11,86%       | 20,21%       | -8,30%                         | 15,73%       | 8,29%    | 69,49%  |
| iShares Core MSCI Europe UCITS ETF EUR (Acc)           | EUNK   | MSCI Europe           | 0,12%          | 8,176                    | EUR      | 2,32%        | 17,34%       | -4,27%                         | 13,80%       | 8,17%    | 52,13%  |
| Amundi MSCI World UCITS ETF (Acc)                       | MWRE   | MSCI World Index      | 0,12%          | 5,287                    | USD      | 12,23%       | 23,32%       | -8,34%                         | 17,03%       | 8,85%    | 77,42%  |
| Amundi Prime All Country World UCITS ETF (Acc)         | WEBN   | MSCI ACWI             | 0,07%          | 0,263                    | EUR      |              |              |                                |              |          |         |
...
> The same applies to iShares IUSQ and Amundi's WEBN.
...
But these are only forecasts. Anything can happen at any time. Political events, wars, or natural disasters could affect them. There are also [analytical blog posts](https://pengejunglen.dk/skal-du-investere-i-emerging-markets/) that offer contrasting views and discourage Emerging Markets.

**The _iShares MSCI ACWI UCITS ETF USD (Acc) (IUSQ)_ is probably the most neutral choice and the one we recommend. The [MSCI ACWI consists of 62% USA-based companies](https://www.msci.com/research-and-insights/visualizing-investment-data/acwi-imi-complete-geographic-breakdown), which are primarily included in the S&P 500, so you're not missing out on the "S&P 500 performance".** Alternatively, if you want everything except Emerging Markets, then _Amundi MSCI World UCITS ETF (Acc) (MWRE)_ should be your choice.
...
The thing with [_Ratepension_ and _Aldersopsparing_ are](https://skat.dk/borger/aarsopgoerelse-forskudsopgoerelse-og-indkomst/pension-og-efterloen/fradrag-for-indbetalinger-til-pension):
...
> **Note**    
> SAXO Bank does not offer _Aldersopsparing_ accounts. Many banks offer _Aldersopsparing_ accounts [but charge custody fees](https://dk-invest-101.github.io/Costs%20of%20Investing#costs-associated-with-investing). Thus, we recommend Nordnet in this case.
...
Now, for the first time, **ETFs are not great choices**. You see, ETFs are great (low ÅOP/TER, high liquidity), but they are inventory-taxed (Dk:_Lagerprincippet_) which can quickly eat up a portion of your profits. That's why we recommend them for low-tax strategies with like _Aktiesparekonto_ and _Aldersopsparing_ which are inventory-taxed anyway.

> _Månedsopsparing_ doesn’t offer tax benefits; it only saves you from paying brokerage fees. Thus, you need to be more careful. 

From now on, your choice determines if your securities are taxed at a minimum of 27% (_Aktieindkomst_) or 37% (_Kapitalindkomst_) and whether they are inventory (_Lagerprincippet_) or realized (_Realisationsprincippet_) taxed.

That is where **we finally take advantage of the _Danish Investment Funds_! [They are taxed as _Aktieindkomst_, and if they pay dividends, they are only taxed when realized (_Realisationsprincippet_)](https://dk-invest-101.github.io/QandA#why-should-we-not-invest-in-etfs-or-accumulating-danish-investment-funds-outside-of-an-aktiesparekonto). Great!**
...
|:-------------------------------------------- |:------------- |:--------------------------------------------------- |:-------------- |:------------------------------------------ |:------------ |:------------ |:------------------------------ |:------------ |:------- |
| Danske Invest Global Indeks (Dis)            | DKIGI         | MSCI World Index                                    | 0,40%          | ≈ 6,4 DKK per share, paid yearly           | 6,26%        | 30,85%       | -13,61%                        | 19,89%       | 78,14%  |
| Sparinvest INDEX Emerging Markets (Dis)      | SPIEMIKL      | MSCI Emerging Markets                               | 0,50%          | ≈ 3,4 DKK per share, paid yearly           | 6,09%        | 5,05%        | -12,24%                        | 7,32%        | 19,19%  |
| Sparinvest INDEX Globale Aktier (Dis)        | SPVIGAKL      | MSCI ACWI Index  (IMI)                                   | 0,50%          | ≈ 3 DKK per share, paid yearly             | 7,25%        | 25,93%       | -13,14%                        | 17,58%       | 83,46%  |
| Danske Invest USA Indeks, klasse DKK d (Dis) | DKIUSAIKLDKKD | USA Stocks, can be used as an alternative to S&P500 | 0,35%          | ≈ 1,5 DKK per share, paid yearly           | -1,79%       | 35,85%       | -15,27%                        | 22,75%       | 71,02%  |
| Storebrand Indeks - Alle Markeder A5 (Acc)   | STIIAM        | MSCI ACWI Index                                     | 0,30%          | none, its an accumulating ETF (Read below) | 7,13%        | 27,72%       | -13,30%                        | 18,90%       | 73,42%  |

Source: www.nordnet.dk & www.morningstar.dk on 19. June 2024

> **About _Storebrand Indeks - Alle Markeder A5 (Acc) (STIIAM)_**    
>  [_Storebrand Indeks - Alle Markeder A (Acc) (STIIAM)_ ](https://www.storebrand.no/privat/fondsark/storebrand?isin=NO0010611148&buy&name=Storebrand%20Indeks%20-%20Alle%20Markeder%20A) is a fairly new Danish investment fund. Even though it should be taxed at 37% (_Kapitalindkomst_) using the inventory method (DK: _Lagerprincippet_), it is somehow taxed at 27% (_Aktieindkomst_) when realized (DK: _Realisationsprincippet_) — which is unusual because it's an accumulating Fund. We've summarized lots of gotcha's that we recommend you read before intent investing in [_Storebrand Indeks - Alle Markeder A (Acc) (STIIAM)_](https://dk-invest-101.github.io/QandA#about--storebrand-indeks---alle-markeder-a-stiiam).

Looking at the above table, the _Danske Inv Global Indeks, kl DKK d (Dis) (DKIGI)_ and _Sparindex INDEX Globale Aktier KL (Dis) (SPVIGAKL)_ are great choices since both follow a diversified MSCI index, had great returns and pay good dividends. 

STIIAM is a great alternative to DKIGI and SPVIGAKL since it's an accumulating Danish Investment Fund and if you are okay with taking a bit more risk which we have highlighted in the [about _Storebrand Indeks - Alle Markeder A (STIIAM)_ section](https://dk-invest-101.github.io/QandA#about--storebrand-indeks---alle-markeder-a-stiiam). You might lose a little when buying or selling due to the low trading volume, and there’s a chance the tax rules could change again in the future.

Thus, **we would recommend investing a monthly amount into the _Danske Inv Global Indeks, kl DKK d (Dis) (DKIGI)_ or _Sparindex INDEX Globale Aktier KL (Dis) (SPVIGAKL)_ Danish Investment Fund with the _Månedsopsparing_ service**.

Both Danish Investment Funds are great alternatives to ETFs outside _Aktiesparekonto_ and _Aldersopsparing_, and are good choices for normal investments too.
...
> Not all Danish investment funds are available through SAXO or Nordnet’s monthly savings plans, as each platform chooses which ones to include.
