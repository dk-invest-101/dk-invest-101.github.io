...
- **Realisationsprincippet** (Eng: Realisation Principle): You pay tax when you realise a return, which means when you sell a Security or receive a dividend. All Stocks and dividend-paying Funds (Mutual and Danish Investment Funds, not ETFs) are taxed using the "Realisationsprincippet".
...
### Deducting Losses
If you lose money, you might be able to subtract those losses from your profits so you don’t have to pay as much tax, or no tax at all. The rules for deducting losses depend on the income type:
- **Aktieindkomst and Aktiesparekonto**:  If you incur losses, you can offset them against your gains in the same category (e.g., Aktiesparekonto losses against Aktiesparekonto gains). You can carrry these losses forward, year after year, until they are fully offset by future profits. Currently, [there’s no time limit](http://skat.dk/skat.aspx?oid=2234844) for how far into the future any loss can be carried forward. 
- **Kapitalindkomst**:  The rules here are slightly more complex. Negative _Kapitalindkomst_ is deducted from your municipal and church taxes, which together typically account for 25% or 33% of your salary tax. Losses can only be deducted from profits earned within the same year.

#### Example 1: How Loss Deduction Works in an Aktiesparekonto
Let’s say you invested in two ETFs (which are like bundles of stocks) using an Aktiesparekonto. Remember that an _Aktiesparekonto_ is taxed following the _Lageprincippet_. Tax is paid on investments annually, regardless of whether they are sold or not. At the end of each year, the increase or decrease in the value of investments is calculated.
- **2021:**
...
Now imagine that in the same year, you sold:

- "Stock A" at a **100,000 DKK loss**, and
- "Stock B" at a **20,000 DKK profit**.

In total, your net _Kapitalindkomst_ (investment income) is 20,000 DKK - 100,000 DKK = **-80,000 DKK** (an 80,000 DKK loss).

You can use this **-80,000 DKK** loss to reduce your municipal and church taxes, as shown in the image below.

![](./assets/Deduct-Example-2.png)


### How do you pay taxes?
When you invest in an **Aktiesparekonto**, taxes are taken care of automatically. Whenever you make money from your investments, taxes are deducted from your account. If you don't have enough cash to cover the taxes, the bank or platform may sell some of your investments or allow your account to go into negative balance to pay the taxes. You'll be notified if this happens and given time (usually 30 days) to add more cash to cover the shortfall. Even if you've already reached the accounts limit of 166.200 DKK (in 2025), you can still add extra cash to cover taxes owed. [Saxo](https://www.home.saxo) is one example where you'll go into a negative balance and add cash to cover for taxes.
