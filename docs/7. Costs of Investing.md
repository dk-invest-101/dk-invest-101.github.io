...
- **Brokerage fee** (DK: Kurtage gebyr): Each time you trade a Security (ETF, Stock,...) you pay a one-time fee to execute the trade. This is called brokerage fee. **Brokerage fee largely depends on which country and exchange the Security is traded at**. Example fees in 2025:
	- [**SAXO**: Minimum of 0,08% or 10 DKK](https://www.home.saxo/da-dk/rates-and-conditions/stocks/commissions)
	- [**Nordnet**: Minimum of 0,10% - 0,15% or 25 DKK](https://www.nordnet.dk/dk/kundeservice/prisliste/standard-bonus-pro)
...
- **Foreign exchange fee** (DK: Vekselomkostninger/valutavekslingsgebyr): When investing in a product that is not traded in the same currency as your account, then you'll pay an exchange fee on your trade. Example rates in 2025:
	- [**SAXO**: 0,25%](https://www.home.saxo/rates-and-conditions/commissions-charges-and-margin-schedule#currency)
	- [**Nordnet**: 0,15%](https://www.nordnet.dk/blog/guide-valutakonto/)
